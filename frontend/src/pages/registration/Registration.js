...
class Registration extends React.Component {
  ...
  onKYCChange = (event) => {
    this.setState({ kyc: event.target.value });
  };
            ...
            <div className="measure">
              <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
                ...
                {/* <label className="db fw6 lh-copy f6" htmlFor="password">
                  ...
                  <button type="button" onClick={this.handleFileUpload1}>
                    {" "}
                    Upload{" "}
                  </button>
                  <br />
                ...
                <div className="mv3">
                  <label className="db fw6 lh-copy f6" htmlFor="kyc">
                    KYC Done
                  </label>
                  <input
                    className="b pa2 input-reset ba bg-transparent hover-bg-black hover-white "
